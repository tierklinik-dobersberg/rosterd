...
require (
	...
	github.com/tierklinik-dobersberg/apis v0.0.0-20230903063102-96738e0eb7af
...
require (
	buf.build/gen/go/bufbuild/protovalidate/protocolbuffers/go v1.31.0-20230721020619-4464c06fa399.1 // indirect
